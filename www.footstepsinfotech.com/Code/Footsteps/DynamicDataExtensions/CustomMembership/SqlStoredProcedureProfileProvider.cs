...
namespace DynamicDataExtensions.CustomMembership
{
     ...
     * 
     */
    public class SqlStoredProcedureProfileProvider : SqlProfileProvider
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            // remove the custom parameters
            config.Remove("commandTimeout");
            config.Remove("readProcedure");
            config.Remove("setProcedure");

            // delegate the call for base initialization
            base.Initialize(name, config);
            
            // following properties are required for base initialization
            // hence clear those afterwards
        ...
        private void GetProfileDataFromSproc(SettingsPropertyCollection properties, SettingsPropertyValueCollection svc, string username, SqlConnection conn, bool userIsAuthenticated)
        {
            ...
            try
            {
                ...
                foreach (SettingsProperty prop in properties)
                {
                    ...
                    {
                        // this is because of the deprecated dataType 0x22 error..
                        // Damn!! need to find out a work around for the same.
                        continue;
                    }
                    ...
                    System.Diagnostics.Debug.WriteLine("varname = " + varname);
                    System.Diagnostics.Debug.WriteLine("value = " + value);
                    System.Diagnostics.Debug.WriteLine("datatype = " + datatype);
        ...
        /// <summary>
        /// Utility Method for Creating an Output SqlParameter which would be returned by the stored procedure
        /// </summary>
        ...
        {
            return base.FindProfilesByUserName(authenticationOption, usernameToMatch, pageIndex, pageSize, out totalRecords);
        }

        public override ProfileInfoCollection FindInactiveProfilesByUserName(ProfileAuthenticationOption authenticationOption, string usernameToMatch, DateTime userInactiveSinceDate, int pageIndex, int pageSize, out int totalRecords)
        {
            return base.FindInactiveProfilesByUserName(authenticationOption, usernameToMatch, userInactiveSinceDate, pageIndex, pageSize, out totalRecords);
        }
    }
}
