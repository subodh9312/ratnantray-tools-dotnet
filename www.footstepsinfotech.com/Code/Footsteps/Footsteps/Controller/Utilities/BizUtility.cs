...
namespace Footsteps.Controller.Utilities
{
    ...
    [EnableClientAccess()]
    public class BizUtility : LinqToEntitiesDomainService<FootstepsEntities>
    {
        #region Comments
        // TODO:
        ...
        public byte[] GetResumeData(string userName)
        {
            object key = Membership.GetUser(userName).ProviderUserKey;
            Database database = DatabaseFactory.CreateDatabase();
            StringBuilder builder = new StringBuilder();
            builder.Append(" SELECT ResumeData FROM aspnet_Custom_UserDetails WHERE Upper(UserId) = '");
