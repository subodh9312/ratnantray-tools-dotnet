    ...
    Inherits="Footsteps.UserControls.RecentComments.RecentComments" EnableViewState="false"
            ...
            <ItemTemplate>
                <table width="100%" cellpadding="1" cellspacing="1">
                    <tr>
                        ...
                        <td width="85%">
                            <li>
                                <%# Footsteps.Controller.Utilities.
                                            BizUtility.ToUpperInvariant(Eval("SubmitterName").ToString()) %>
                                &nbsp;says :
                                <%# GetDisplayText(Footsteps.Controller.Utilities.BizUtility.ToUpperInvariant(Eval("CommentText").ToString()))%></li>
                        </td>
                        <td width="10%">
