...
namespace Footsteps {
    ...
    public partial class WebProfile {
        ...
        public virtual string ContactNo {
            get {
                return ((string)(this.GetPropertyValue("ContactNo")));
            }
            set {
                this.SetPropertyValue("ContactNo", value);
            }
        }
        
        public virtual byte[] ResumeData {
            get {
                return ((byte[])(this.GetPropertyValue("ResumeData")));
            }
            set {
                this.SetPropertyValue("ResumeData", value);
            }
        }
        ...
        public virtual string EmailAddress {
            ...
            set {
                this.SetPropertyValue("EmailAddress", value);
            }
        }
        ...
        public virtual string WorkPreference {
            get {
                return ((string)(this.GetPropertyValue("WorkPreference")));
            }
            set {
                this.SetPropertyValue("WorkPreference", value);
            }
        }
