<%@ Control Language="C#" CodeBehind="Decimal_Edit.ascx.cs" Inherits="mytemplate.Decimal_EditField" %>

<asp:TextBox ID="TextBox1" runat="server" CssClass="DDTextBox" Text='<%# FieldValueEditString %>' Columns="10"></asp:TextBox>
<asp:Label ID="AdditionalInfoLabel" runat="server" ViewStateMode="Disabled" Visible="false"
    EnableViewState="false" Text="" ToolTip="" />
