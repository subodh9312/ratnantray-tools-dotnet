<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="ListDetails.aspx.cs" Inherits="mytemplate.ListDetails" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="DD">
                ...
                <asp:DomainValidator runat="server" ID="FormViewValidator" ControlToValidate="FormView1" Display="None" CssClass="DDValidator" />
            ...
            <asp:DomainDataSource ID="GridDataSource" runat="server" EnableDelete="true" EnableUpdate="true" />
            ...
            <asp:Panel ID="DetailsPanel" runat="server">
                ...
                <asp:FormView ID="FormView1" runat="server" DataSourceID="DetailsDataSource" RenderOuterTable="false"
                    ...
                    <ItemTemplate>
                        ...
                        <tr class="td">
                            <td colspan="2">
                                <asp:LinkButton runat="server" CommandName="Edit" Text="Edit" Visible='<%# table.CanUpdate(User) %>' />
                                <asp:LinkButton runat="server" CommandName="Delete" Text="Delete" Visible='<%# table.CanDelete(User) %>'
                                    OnClientClick='return confirm("Are you sure you want to delete this item?");' />
                                <asp:LinkButton runat="server" CommandName="New" Text="New" Visible='<%# table.CanInsert(User) %>' />
                            </td>
                        </tr>
                    </ItemTemplate>
                    <EditItemTemplate>
                ...
                <asp:DomainDataSource ID="DetailsDataSource" runat="server" EnableDelete="true" EnableInsert="true" EnableUpdate="true" />
