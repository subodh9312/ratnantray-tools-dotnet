<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Comment.ascx.cs" Inherits="mytemplate.UserControls.CommentCtrl.CommentCtrl" %>
        ...
        <asp:GridView ID="GV1" runat="server" CellPadding="4" Width="100%" AllowPaging="True"
            ...
            <Columns>
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <span>
                            <%# mytemplate.Controller.Utilities.BizUtility.ToUpperInvariant(Eval("SubmitterName").ToString())  %>
