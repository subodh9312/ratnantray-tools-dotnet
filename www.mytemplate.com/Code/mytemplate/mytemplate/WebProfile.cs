...
namespace mytemplate {
    ...
    public partial class WebProfile {
        ...
        public virtual string Extension {
            get {
                return ((string)(this.GetPropertyValue("Extension")));
            }
            set {
                this.SetPropertyValue("Extension", value);
            }
        }
        
        public virtual string SwitchBoardNo {
            get {
                return ((string)(this.GetPropertyValue("SwitchBoardNo")));
            }
            set {
                this.SetPropertyValue("SwitchBoardNo", value);
            }
        }
        
        public virtual byte[] ProfilePicture {
            get {
                return ((byte[])(this.GetPropertyValue("ProfilePicture")));
            }
            set {
        ...
        public virtual string Organisation {
            get {
                return ((string)(this.GetPropertyValue("Organisation")));
            }
            set {
                this.SetPropertyValue("Organisation", value);
            }
        }
        ...
        public virtual string CellNo2 {
            get {
                return ((string)(this.GetPropertyValue("CellNo2")));
            }
            set {
                this.SetPropertyValue("CellNo2", value);
            }
        }
        ...
        public virtual string Education {
            get {
                return ((string)(this.GetPropertyValue("Education")));
            }
            set {
                this.SetPropertyValue("Education", value);
            }
        }
        
        public virtual string CellNo1 {
            get {
                return ((string)(this.GetPropertyValue("CellNo1")));
            }
            set {
                this.SetPropertyValue("CellNo1", value);
            }
        }
        
        public virtual string DirectNo {
            get {
                return ((string)(this.GetPropertyValue("DirectNo")));
            }
            set {
                this.SetPropertyValue("DirectNo", value);
            }
        }
